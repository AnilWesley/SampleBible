...
public class TableListAdapter implements ListAdapter {
    Context  context;
    List<String> index,miracles,matthew,mark,luke,john;
    TextView textView,textView2,textView3,textView4,textView5;


    TableListAdapter(Context context, List<String> index, List<String> miracles, List<String> matthew,
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        @SuppressLint("ViewHolder") View listviewitem=layoutInflater.inflate(R.layout.table_view,null,true);
